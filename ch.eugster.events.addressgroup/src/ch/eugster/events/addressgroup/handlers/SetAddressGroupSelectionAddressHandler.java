...
public class SetAddressGroupSelectionAddressHandler extends AbstractHandler implements IHandler, IElementUpdater
{
	@Override
	public Object execute(ExecutionEvent event) throws ExecutionException
	{
		...
		if (ctx instanceof EvaluationContext)
		{
			...
			if (part instanceof PersonAddressGroupMemberView)
			{
				...
				view.setMode(AddressGroupMemberParentType.ADDRESS);
				...
				service.refreshElements("ch.eugster.events.addressgroup.command.set.addressgroup.selection.link", null);
	...
	public void updateElement(UIElement element, Map map)
	{
		...
		State state = command.getState("ch.eugster.events.addressgroup.person.view.selection.address.state");
