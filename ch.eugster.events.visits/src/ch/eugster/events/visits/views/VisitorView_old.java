...
public class VisitorView_old extends ViewPart implements IViewPart
{
...
//				}
			...
			public void eventsMoved(final List events, final MouseEvent mouseEvent)
			{
				for (Object evt : events)
				{
					...
					event.setAdvancedTooltip(VisitorView_old.this.getTooltip(visit));
