...
import ch.eugster.events.course.reporting.dialogs.CourseDescriptionDialog;

public class GenerateCourseDescriptionHandler extends AbstractHandler implements IHandler
{
	...
	public Object execute(final ExecutionEvent event) throws ExecutionException
	{
		if (event.getApplicationContext() instanceof EvaluationContext)
		{
			...
			if (selection instanceof IStructuredSelection)
			{
				...
				{
					CourseDescriptionDialog dialog = new CourseDescriptionDialog(shell, ssel);
					dialog.open();
				}
			}
		}
