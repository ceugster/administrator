...
public class DatabaseTagReportListener extends AbstractStartableTagReportListener implements IPropertyChangeListener
{
	...
	public DatabaseTagReportListener(CharityRunTagReadQuery query)
	{
		this.query = query;
	}
