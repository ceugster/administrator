					...
					public IStatus runInUIThread(final IProgressMonitor monitor)
					{
						...
						for (Object element : elements)
						{
							if (element instanceof AddressGroupCategory)
							{
								...
								AddressGroupCategoryQuery query = (AddressGroupCategoryQuery) service.getQuery(category
										.getClass());
							...
							else if (element instanceof AddressGroup)
							{
								...
								AddressGroupQuery query = (AddressGroupQuery) service.getQuery(group.getClass());
								query.delete(group);
							}
							...
							else if (element instanceof AddressGroupMember)
							{
								...
								AddressGroupMemberQuery query = (AddressGroupMemberQuery) service.getQuery(member
										.getClass());
								query.delete(member);
							}
							monitor.worked(1);
