...
public class ChangeAddressTypeDialog extends TitleAreaDialog
{
	...
	public ChangeAddressTypeDialog(Shell shell, FormEditorLinkPage currentPage, AddressType[] selectableAddressTypes)
	{
		super(shell);
	...
	private FormEditorPersonPage getPersonPage(PersonFormEditor editor)
	{
