...
public class SaveFileFieldEditor extends ExtendedFileFieldEditor
{
	 ...
	 */
	public SaveFileFieldEditor(String name, String labelText, boolean enforceAbsolute, Composite parent)
	{
	 ...
	 *      Composite)
	 */
	public SaveFileFieldEditor(String name, String labelText, boolean enforceAbsolute, int validationStrategy,
			Composite parent)
	{
